...
class RouterClient:
    ...
    def list_models(self) -> List[str]:
        ...
        # normalize to list of strings if API returns [{"id":"..."}]
        out: List[str] = []
        for m in models:
...
def get_faqs() -> List[FAQ]:
    return [
        FAQ(
            "What programs does Islington College offer?",
        ...
        FAQ(
            "Are there internships or industry links?",
...
def chat(
    ...
    """
    - Non-interactive: pass --prompt/-p "your question"
    - Interactive:     pass --interactive/-i to start the FAQ chatbot
    """
    settings = ClientSettings()
    client = RouterClient(settings)
    ...
    try:
        if interactive:
            ...
            while True:
                ...
                # free-form question -> call your model
